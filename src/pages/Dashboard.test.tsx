...
describe("operating dashboard", () => {
  beforeEach(() => {
    localStorage.clear();
    vi.stubGlobal("fetch", vi.fn(async () => new Response(JSON.stringify({ ok: true, ai_configured: false, model: "gpt-5.6" }), { status: 200, headers: { "content-type": "application/json" } })));
  });
